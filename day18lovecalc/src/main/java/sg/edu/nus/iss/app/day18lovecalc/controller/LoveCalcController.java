package sg.edu.nus.iss.app.day18lovecalc.controller;
...
import sg.edu.nus.iss.app.day18lovecalc.service.LoveCalcService;
...
public class LoveCalcController {
    ...
    public String getAllResult(Model model){
        List<Calculator> results = loveCalcSvc.findAll();
